...
_TEMPORAL_KERNEL_BASIS = {
    ...
    "slowfast_gaze": [
        [[1], [5],[5]],  # conv1 temporal kernel for slow and fast pathway.
        [[1], [3],[3]],  # res2 temporal kernel for slow and fast pathway.
        [[1], [3],[3]],  # res3 temporal kernel for slow and fast pathway.
        [[3], [3],[3]],  # res4 temporal kernel for slow and fast pathway.
        [[3], [3],[3]],  # res5 temporal kernel for slow and fast pathway.
    ],
    "x3d": [
...
_POOL1 = {
    ...
    "slowfast_gaze": [[1, 1, 1], [1, 1, 1], [1, 1, 1]],
    "x3d": [[1, 1, 1]],
}
...
class FuseFastToSlow(nn.Module):
    ...
    def forward(self, x):
        ...
        fuse = self.bn(fuse)
        fuse = self.relu(fuse)
        fuse2 = self.conv_g2s(x_g)
        fuse2 = self.bn(fuse2)
        fuse2 = self.relu(fuse2)
        x_s_fuse = torch.cat([x_s, fuse], 1)
        x_g_fuse= torch.cat([x_s_fuse, fuse2], 1)
        return [x_g_fuse, x_f,x_g]


@MODEL_REGISTRY.register()
class SlowFast_gaze(nn.Module):
    """
    ...
    def __init__(self, cfg):
        ...
        """
        super(SlowFast_gaze, self).__init__()
    ...
    def _construct_network(self, cfg):
        ...
        self.s1 = stem_helper.VideoModelStem(
            ...
            dim_out=[width_per_group, width_per_group // cfg.SLOWFAST.BETA_INV,width_per_group // cfg.SLOWFAST.BETA_INV],
            kernel=[temp_kernel[0][0] + [7, 7], temp_kernel[0][1] + [7, 7],temp_kernel[0][2] + [7, 7]],
            stride=[[1, 2, 2]] * 3,
            padding=[
                [temp_kernel[0][0][0] // 2, 3, 3],
                [temp_kernel[0][1][0] // 2, 3, 3],
                [temp_kernel[0][2][0] // 2, 3, 3],
            ],
        ...
        self.s2 = resnet_helper.ResStage(
            ...
            dim_inner=[dim_inner, dim_inner // cfg.SLOWFAST.BETA_INV, dim_inner // cfg.SLOWFAST.BETA_INV],
        ...
        self.s3 = resnet_helper.ResStage(
            ...
            dim_inner=[dim_inner * 2, dim_inner * 2 // cfg.SLOWFAST.BETA_INV,dim_inner * 2 // cfg.SLOWFAST.BETA_INV],
        ...
        self.s4 = resnet_helper.ResStage(
            ...
            dim_inner=[dim_inner * 4, dim_inner * 4 // cfg.SLOWFAST.BETA_INV, dim_inner * 4 // cfg.SLOWFAST.BETA_INV],
        ...
        self.s5 = resnet_helper.ResStage(
            ...
            dim_inner=[dim_inner * 8, dim_inner * 8 // cfg.SLOWFAST.BETA_INV ,dim_inner * 8 // cfg.SLOWFAST.BETA_INV],
        ...
        if cfg.DETECTION.ENABLE:
            self.head = head_helper.ResNetRoIHead(
                ...
                pool_size=[
                    ...
                    [cfg.DATA.NUM_FRAMES // pool_size[2][0], 1, 1],
                ],
                resolution=[[cfg.DETECTION.ROI_XFORM_RESOLUTION] * 2] * 3,
                scale_factor=[cfg.DETECTION.SPATIAL_SCALE_FACTOR] * 3,
            ...
            self.head = head_helper.ResNetBasicHead(
                ...
                or cfg.MODEL.MODEL_NAME == "ContrastiveModel"
                    ...
                    [
                        cfg.DATA.NUM_FRAMES // pool_size[2][0],
                        cfg.DATA.TRAIN_CROP_SIZE // 32 // pool_size[2][1],
                        cfg.DATA.TRAIN_CROP_SIZE // 32 // pool_size[2][2],
                    ],
...
#             dim_in=cfg.DATA.INPUT_CHANNEL_NUM+[1],
